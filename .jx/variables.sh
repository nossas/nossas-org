...
export JENKINS_X_URL='http://dashboard-jx.35.170.28.138.nip.io/nossas/nossas-org/main/18'
export JX_CHART_REPOSITORY='http://jenkins-x-chartmuseum.jx.svc.cluster.local:8080'
export MINK_AS='tekton-bot'
export MINK_IMAGE='519061744633.dkr.ecr.us-east-1.amazonaws.com/nossas/nossas-org:0.3.5'
