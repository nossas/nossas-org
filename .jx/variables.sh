...
export DOMAIN='dev.nossas.org'
export GIT_BRANCH='main'
export JENKINS_X_URL='http://dashboard-jx.dev.nossas.org/nossas/nossas-org/main/3'
...
export MINK_IMAGE='519061744633.dkr.ecr.us-east-1.amazonaws.com/nossas/nossas-org:0.11.0'
