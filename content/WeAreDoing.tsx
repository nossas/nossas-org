      ...
      <SliderPanel
        ...
        items={[
          ...
          },
          {
            ...
            alt: t("we-are-doing.sliders.18.title"),
            title: t("we-are-doing.sliders.18.title"),
            description: t("we-are-doing.sliders.18.description"),
            link: t("we-are-doing.sliders.18.navigate"),
          },
          {
            src: "/static/media/we-are-doing/sai-da-fossa-manaus.png",
            href: "https://www.saidafossa.minhamanaus.org.br/",
            alt: t("we-are-doing.sliders.19.title"),
            title: t("we-are-doing.sliders.19.title"),
            description: t("we-are-doing.sliders.19.description"),
            link: t("we-are-doing.sliders.19.navigate"),
          },
        ]}
      />
    </Section>
